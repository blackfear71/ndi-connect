...
class MessageHelper
{
    ...
    private static array $httpCodes = [
        ...
        self::ERR_INVALID_END_TIME   => 400,
        self::ERR_INVALID_LOCATION   => 400,
        self::ERR_INVALID_START_TIME => 400,

        // Participants
        self::ERR_INVALID_POINTS   => 400,
        self::ERR_PLAYER_GIVEAWAY  => 400,
        self::ERR_PLAYER_NOT_FOUND => 400,

        // Cadeaux
        self::ERR_GIFT_NOT_FOUND       => 400,
        self::ERR_INVALID_VALUE        => 400,
        self::ERR_QUANTITY_ATTRIBUTION => 400,

        // Récompenses
        self::ERR_INVALID_GIFT_POINTS => 400,
    ...
    private static array $messages = [
        ...
        self::ERR_INVALID_QUANTITY       => 'La quantité doit être supérieure à 0',
        ...
        // Editions
        self::ERR_EDITION_NOT_FOUND  => 'Erreur lors de la récupération de l\'édition',
        self::ERR_EDITION_FINISHED   => 'Edition terminée ou introuvable',
        self::ERR_INVALID_DATE       => 'Le format de la date est invalide',
        self::ERR_INVALID_END_TIME   => 'Le format de l\'heure de fin est invalide',
        self::ERR_INVALID_LOCATION   => 'Le lieu est obligatoire',
        self::ERR_INVALID_START_TIME => 'Le format de l\'heure de début est invalide',

        // Participants
        self::ERR_INVALID_POINTS   => 'Le nombre de points doit être supérieur ou égal à 0',
        ...
        self::ERR_INVALID_VALUE        => 'La valeur doit être supérieure à 0',
        self::ERR_QUANTITY_ATTRIBUTION => 'La quantité doit être supérieure ou égale au nombre de cadeaux déjà attribués',

        // Récompenses
        self::ERR_INVALID_GIFT_POINTS => 'Le nombre de points est insuffisant pour le cadeau',
