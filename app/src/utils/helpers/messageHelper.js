...
export const getMessageTranslationKey = (code, params, t) => {
    ...
    const map = {
        ...
        ERR_EDITIONS_SEARCH: 'errors.editionsNotFound',
        ...
        ERR_FORBIDDEN_FILE: 'errors.unknownError',
        ERR_GIFTS_NOT_FOUND: 'errors.giftsNotFound',
        ...
        ERR_PLAYERS_NOT_FOUND: 'errors.playersNotFound',
