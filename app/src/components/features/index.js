export { default as EditionAbout } from './EditionAbout/EditionAbout';
export { default as EditionGifts } from './EditionGifts/EditionGifts';
...
export { default as SettingsPassword } from './SettingsPassword/SettingsPassword';
